...
if (!$reportView) {
  ...
  <?php
    ...
    function showOverduedList($obj_db, $array_data)
    {
        ...
        $_buffer .= __('Kirim Pesan Whatsapp') . ': <a href="https://wa.me/' .$member_d[2]. '?text=Halo, *' .$member_name.'* Kami dari WANALA bermaksud mengingatkan bahwa anda memiliki peminjaman alat di WANALA yang belum dikembalikan. Mohon kembalikan ke WANALA segera yaaa, silahkan hubungi nomor berikut ini 085230712324 (Aliefia Iswanto) "target="_blank">' . $member_d[2] . '</a></div>';
